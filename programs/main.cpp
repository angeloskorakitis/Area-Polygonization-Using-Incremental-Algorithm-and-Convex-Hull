...
void print_convex_hull(Polygon);
...
int main(int argc, char *argv[])
{
  ...
  // Πολυγωνοποίηση
  // Polygon polygon1 = incremental_algorithm(vertices);
...
//   {
//     // Υπολογισμός του ΚΠ
//     CGAL::ch_bykat(polygon.edges_begin(), polygon.edges_end(), convex_hull);
...
void print_convex_hull(Polygon polygon) {
