...
-   Οδηγίες μεταγλώττισης και χρήσης του προγράμματος:
    ...
    cgal_create_CMakeLists -s main (ΠΡΟΣΟΧΗ! Δεν θα χρειαστεί η εκτέλεση της πρώτης εντολής, καθώς περιέχεται στο αρχείο για την διασφάλιση των dependencies μεταξύ των διαφόρων αρχείων.)
